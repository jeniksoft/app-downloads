...
| --- | --- | --- | --- | --- |
| Codex VeraCrypt Startup Mount | 1.0.188 | [VeraCryptStartupMountSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/veracrypt-startup-mount/VeraCryptStartupMountSetup.exe) | [Popis a návod](veracrypt-startup-mount/README.md) | [`4E1E5F13...735A1BFA`](../checksums/SHA256SUMS.txt) |
