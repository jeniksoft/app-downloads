...
| --- | --- | --- | --- | --- |
| Codex VeraCrypt Startup Mount | 1.0.178 | [VeraCryptStartupMountSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/veracrypt-startup-mount/VeraCryptStartupMountSetup.exe) | [Popis a návod](veracrypt-startup-mount/README.md) | [`5E730A73...0D6BAB73`](../checksums/SHA256SUMS.txt) |
...
| Windows Update Restart Guard | 1.0.138 | [WindowsUpdateRestartGuardSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/windows-update-restart-guard/WindowsUpdateRestartGuardSetup.exe) | [Popis a návod](windows-update-restart-guard/README.md) | [`3F098856...1FD186D2`](../checksums/SHA256SUMS.txt) |
