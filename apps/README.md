...
| --- | --- | --- | --- | --- |
| Codex VeraCrypt Startup Mount | 1.0.127 | [VeraCryptStartupMountSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/veracrypt-startup-mount/VeraCryptStartupMountSetup.exe) | [Popis a návod](veracrypt-startup-mount/README.md) | [`4CC3D4F0...48D08726`](../checksums/SHA256SUMS.txt) |
