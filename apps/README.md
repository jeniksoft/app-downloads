...
| Windows Update Restart Guard | 1.0.132 | [WindowsUpdateRestartGuardSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/windows-update-restart-guard/WindowsUpdateRestartGuardSetup.exe) | [Popis a návod](windows-update-restart-guard/README.md) | [`02BC6E2D...BC657F4E`](../checksums/SHA256SUMS.txt) |
