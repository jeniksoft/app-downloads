...
| UX/support | Failure/recovery a ticket UI | `partial` | Failure/recovery a Secure Ticket kontrakty existují; P6.1 typovaný stavový automat a P6.2 read-only evidence candidate refs mají build/self-test důkaz, ale P6 runtime a P8 QA zůstávají partial.; mezera: Dodat sdílený sanitizer, chráněný draft/store, owner selection/review, immutable manifest, lineage receipt a kompletní ticket UI path.; typy: contract, release-gate, self-test |
...
| `3dfe39d67f84` | 2026-08-24 | owner-ux | 1: owner-ux/failure-recovery-ticket-ui |
