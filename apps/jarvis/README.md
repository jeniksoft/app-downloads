...
Řez `cifrspion-m43-backup-evidence-readback` je veřejně spojen se zdrojovým SHA `c9fc72b3d0d4994db3b6117ea1804df836cd4e07` a closeout SHA `c9fc72b3d0d4994db3b6117ea1804df836cd4e07`. Stav: **verified**.
...
| --- | ---: | ---: | ---: |
| C/C++ | 1 788 | 541 703 | 27.56 |
| JSON | 362 | 169 316 | 30.33 |
| Markdown | 898 | 118 594 | 6.32 |
| Python | 486 | 84 712 | 3.51 |
| PowerShell | 64 | 30 309 | 1.58 |
| Other text | 76 | 5 791 | 0.29 |
| JSONL | 16 | 2 515 | 6.93 |
...
| **Text/source celkem** | **3 847** | **956 096** | **76.83** |
| Binární assety (mimo řádky) | 41 | — | 14.68 |
| **Trackovaný strom celkem** | **3 888** | **956 096** | **91.51** |
...
| --- | ---: | ---: | ---: |
| Text/source celkem | +0 | +141 | +0.01 |
| Binární assety | +0 | — | +0.00 |
| Trackovaný strom celkem | +0 | +141 | +0.01 |
...
Optimalizace běhu: 103 inkrementálních closeout bodů od posledního úplného baseline, žádný klon `app-downloads`, žádný úplný průchod soukromou historií a nejvýše jeden veřejný commit; bajtově se publikují jen změněné JSON, README, historické a SVG artefakty.
