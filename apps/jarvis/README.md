...
Řez `PF1.5.migration-fixture` je veřejně spojen se zdrojovým SHA `987a582991f1a8e3d80f2eae29f3e71e1a444ceb` a closeout SHA `c9ee2d8339acfb858fb041bc3868ff98cdae88fb`. Stav: **verified**.
...
| Markdown | 827 | 101 311 | 5.26 |
| Python | 295 | 66 891 | 2.71 |
...
| **Text/source celkem** | **2 856** | **804 603** | **52.43** |
| Binární assety (mimo řádky) | 40 | — | 14.61 |
| **Trackovaný strom celkem** | **2 896** | **804 603** | **67.03** |
...
| --- | ---: | ---: | ---: |
| Text/source celkem | +1 | +309 | +0.02 |
| Binární assety | +0 | — | +0.00 |
| Trackovaný strom celkem | +1 | +309 | +0.02 |
...
Optimalizace běhu: 74 inkrementálních closeout bodů od posledního úplného baseline, žádný klon `app-downloads`, žádný úplný průchod soukromou historií a nejvýše jeden veřejný commit; bajtově se publikují jen změněné JSON, README, historické a SVG artefakty.
