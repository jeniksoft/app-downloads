...
Řez `OP1.4.2.summary-system-headings` je veřejně spojen se zdrojovým SHA `432d83c5557c533a86f9409a8cf22979d4348a77` a closeout SHA `432d83c5557c533a86f9409a8cf22979d4348a77`. Stav: **verified**.
...
| --- | ---: | ---: | ---: |
| C/C++ | 1 145 | 420 484 | 23.18 |
| JSON | 314 | 164 694 | 12.60 |
| Markdown | 799 | 95 093 | 4.90 |
| Python | 262 | 59 154 | 2.38 |
...
| **Text/source celkem** | **2 735** | **771 023** | **51.63** |
| Binární assety (mimo řádky) | 40 | — | 14.61 |
| **Trackovaný strom celkem** | **2 775** | **771 023** | **66.24** |
...
| --- | ---: | ---: | ---: |
| Text/source celkem | +0 | +177 | +0.01 |
| Binární assety | +0 | — | +0.00 |
| Trackovaný strom celkem | +0 | +177 | +0.01 |
...
Optimalizace běhu: 40 inkrementálních closeout bodů od posledního úplného baseline, žádný klon `app-downloads`, žádný úplný průchod soukromou historií a nejvýše jeden veřejný commit; bajtově se publikují jen změněné JSON, README, historické a SVG artefakty.
