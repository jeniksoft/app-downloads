...
Řez `OP3.8.3` je veřejně spojen se zdrojovým SHA `e0465c3cbde994b1dd8b2489a813b96c4d96fe62` a closeout SHA `2b421f71b2144ee04eadb45014c248d83ba8dde1`. Stav: **verified**.
...
| --- | ---: | ---: | ---: |
| C/C++ | 1 153 | 427 801 | 22.55 |
| JSON | 336 | 167 080 | 12.85 |
| Markdown | 823 | 97 973 | 5.07 |
| Python | 273 | 62 702 | 2.53 |
...
| **Text/source celkem** | **2 818** | **787 384** | **51.59** |
| Binární assety (mimo řádky) | 40 | — | 14.61 |
| **Trackovaný strom celkem** | **2 858** | **787 384** | **66.19** |
...
| --- | ---: | ---: | ---: |
| Text/source celkem | +1 | +412 | +0.02 |
| Binární assety | +0 | — | +0.00 |
| Trackovaný strom celkem | +1 | +412 | +0.02 |
...
Optimalizace běhu: 55 inkrementálních closeout bodů od posledního úplného baseline, žádný klon `app-downloads`, žádný úplný průchod soukromou historií a nejvýše jeden veřejný commit; bajtově se publikují jen změněné JSON, README, historické a SVG artefakty.
