...
| --- | --- | --- | --- | --- |
| Codex VeraCrypt Startup Mount | 1.0.163 | [VeraCryptStartupMountSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/veracrypt-startup-mount/VeraCryptStartupMountSetup.exe) | [Popis a návod](apps/veracrypt-startup-mount/README.md) | [`343AB22A...D88AA505`](checksums/SHA256SUMS.txt) |
