...
| --- | --- | --- | --- | --- |
| Codex VeraCrypt Startup Mount | 1.0.173 | [VeraCryptStartupMountSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/veracrypt-startup-mount/VeraCryptStartupMountSetup.exe) | [Popis a návod](apps/veracrypt-startup-mount/README.md) | [`B4B9D952...1FE69442`](checksums/SHA256SUMS.txt) |
...
| Windows Update Restart Guard | 1.0.132 | [WindowsUpdateRestartGuardSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/windows-update-restart-guard/WindowsUpdateRestartGuardSetup.exe) | [Popis a návod](apps/windows-update-restart-guard/README.md) | [`02BC6E2D...BC657F4E`](checksums/SHA256SUMS.txt) |
...
| WDUi Durable App Template | 1.0.41 | [WduiDurableAppTemplateSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/wdui-durable-app-template/WduiDurableAppTemplateSetup.exe) | [Popis a návod](apps/wdui-durable-app-template/README.md) | [`D984C1C7...C472988C`](checksums/SHA256SUMS.txt) |
