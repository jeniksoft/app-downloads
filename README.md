...
| WDUi Framework SDK | 0.1.2 | [WduiFrameworkSdk-0.1.2.zip](https://github.com/jeniksoft/app-downloads/raw/main/apps/wdui-framework/WduiFrameworkSdk-0.1.2.zip) | [Popis a návod](apps/wdui-framework/README.md) | [`C4DD44D2...7E8E6ABC`](checksums/SHA256SUMS.txt) |
| Windows Update Restart Guard | 1.0.112 | [WindowsUpdateRestartGuardSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/windows-update-restart-guard/WindowsUpdateRestartGuardSetup.exe) | [Popis a návod](apps/windows-update-restart-guard/README.md) | [`174F75B1...2CC37BF2`](checksums/SHA256SUMS.txt) |
