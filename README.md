...
| WDUi Framework SDK | 0.1.12 | [WduiFrameworkSdk-0.1.12.zip](https://github.com/jeniksoft/app-downloads/raw/main/apps/wdui-framework/WduiFrameworkSdk-0.1.12.zip) | [Popis a návod](apps/wdui-framework/README.md) | [`A21F21B5...18F67E62`](checksums/SHA256SUMS.txt) |
| Windows Update Restart Guard | 1.0.126 | [WindowsUpdateRestartGuardSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/windows-update-restart-guard/WindowsUpdateRestartGuardSetup.exe) | [Popis a návod](apps/windows-update-restart-guard/README.md) | [`71483458...9AEFDEBE`](checksums/SHA256SUMS.txt) |
