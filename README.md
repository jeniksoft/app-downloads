...
| WDUi Framework SDK | 0.1.1 | [WduiFrameworkSdk-0.1.1.zip](https://github.com/jeniksoft/app-downloads/raw/main/apps/wdui-framework/WduiFrameworkSdk-0.1.1.zip) | [Popis a návod](apps/wdui-framework/README.md) | [`ACDE4C0C...EF7EF978`](checksums/SHA256SUMS.txt) |
| Windows Update Restart Guard | 1.0.110 | [WindowsUpdateRestartGuardSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/windows-update-restart-guard/WindowsUpdateRestartGuardSetup.exe) | [Popis a návod](apps/windows-update-restart-guard/README.md) | [`0A5E6552...ECFF4905`](checksums/SHA256SUMS.txt) |
