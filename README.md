...
| --- | --- | --- | --- | --- |
| VeraCrypt Startup Mount | 1.0.181 | [VeraCryptStartupMountSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/veracrypt-startup-mount/VeraCryptStartupMountSetup.exe) | [Popis a návod](apps/veracrypt-startup-mount/README.md) | [`C59C9C20...AB563C44`](checksums/SHA256SUMS.txt) |
