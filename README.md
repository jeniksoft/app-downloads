...
| --- | --- | --- | --- | --- |
| Windows Update Restart Guard | 1.0.43 | [WindowsUpdateRestartGuardSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/windows-update-restart-guard/WindowsUpdateRestartGuardSetup.exe) | [Popis a návod](apps/windows-update-restart-guard/README.md) | [`86225BB4...15AFED75`](checksums/SHA256SUMS.txt) |
