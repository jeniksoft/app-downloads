...
| WDUi Framework SDK | 0.1.10 | [WduiFrameworkSdk-0.1.10.zip](https://github.com/jeniksoft/app-downloads/raw/main/apps/wdui-framework/WduiFrameworkSdk-0.1.10.zip) | [Popis a návod](apps/wdui-framework/README.md) | [`A77B2873...4BC01D20`](checksums/SHA256SUMS.txt) |
| Windows Update Restart Guard | 1.0.123 | [WindowsUpdateRestartGuardSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/windows-update-restart-guard/WindowsUpdateRestartGuardSetup.exe) | [Popis a návod](apps/windows-update-restart-guard/README.md) | [`B75DA580...3F23FF84`](checksums/SHA256SUMS.txt) |
