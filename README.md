...
| --- | --- | --- | --- | --- |
| Codex VeraCrypt Startup Mount | 1.0.158 | [VeraCryptStartupMountSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/veracrypt-startup-mount/VeraCryptStartupMountSetup.exe) | [Popis a návod](apps/veracrypt-startup-mount/README.md) | [`FF3C0F4C...41763ECF`](checksums/SHA256SUMS.txt) |
