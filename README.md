...
| --- | --- | --- | --- | --- |
| Codex VeraCrypt Startup Mount | 1.0.7 | [VeraCryptStartupMountSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/veracrypt-startup-mount/VeraCryptStartupMountSetup.exe) | [Popis a návod](apps/veracrypt-startup-mount/README.md) | [`8AF842FD...7B201C82`](checksums/SHA256SUMS.txt) |
| Windows Update Restart Guard | 1.0.77 | [WindowsUpdateRestartGuardSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/windows-update-restart-guard/WindowsUpdateRestartGuardSetup.exe) | [Popis a návod](apps/windows-update-restart-guard/README.md) | [`F0788CBE...A8ED7194`](checksums/SHA256SUMS.txt) |
