...
| --- | --- | --- | --- | --- |
| Codex VeraCrypt Startup Mount | 1.0.125 | [VeraCryptStartupMountSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/veracrypt-startup-mount/VeraCryptStartupMountSetup.exe) | [Popis a návod](apps/veracrypt-startup-mount/README.md) | [`37A66E15...F1F1AEB0`](checksums/SHA256SUMS.txt) |
| Jarvis | 0.1.153 | [JarvisSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/personal-codex-fallback-host/JarvisSetup.exe) | [Popis a návod](apps/personal-codex-fallback-host/README.md) | [`7377C0B8...DB1B9870`](checksums/SHA256SUMS.txt) |
