...
| --- | --- | --- | --- | --- |
| Windows Update Restart Guard | 1.0.55 | [WindowsUpdateRestartGuardSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/windows-update-restart-guard/WindowsUpdateRestartGuardSetup.exe) | [Popis a návod](apps/windows-update-restart-guard/README.md) | [`73EB9121...722673AB`](checksums/SHA256SUMS.txt) |
