...
| --- | --- | --- | --- | --- |
| Codex VeraCrypt Startup Mount | 1.0.63 | [VeraCryptStartupMountSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/veracrypt-startup-mount/VeraCryptStartupMountSetup.exe) | [Popis a návod](apps/veracrypt-startup-mount/README.md) | [`C7D67525...1E58344A`](checksums/SHA256SUMS.txt) |
| Jarvis | 0.1.100 | [JarvisSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/personal-codex-fallback-host/JarvisSetup.exe) | [Popis a návod](apps/personal-codex-fallback-host/README.md) | [`FBBC91FD...6DEB1288`](checksums/SHA256SUMS.txt) |
