...
| --- | --- | --- | --- | --- |
| Codex VeraCrypt Startup Mount | 1.0.172 | [VeraCryptStartupMountSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/veracrypt-startup-mount/VeraCryptStartupMountSetup.exe) | [Popis a návod](apps/veracrypt-startup-mount/README.md) | [`6BC5B908...5ACAF93C`](checksums/SHA256SUMS.txt) |
...
| Windows Update Restart Guard | 1.0.131 | [WindowsUpdateRestartGuardSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/windows-update-restart-guard/WindowsUpdateRestartGuardSetup.exe) | [Popis a návod](apps/windows-update-restart-guard/README.md) | [`7A58A2EB...5B4DB3F1`](checksums/SHA256SUMS.txt) |
