...
| WDUi Framework SDK | 0.1.7 | [WduiFrameworkSdk-0.1.7.zip](https://github.com/jeniksoft/app-downloads/raw/main/apps/wdui-framework/WduiFrameworkSdk-0.1.7.zip) | [Popis a návod](apps/wdui-framework/README.md) | [`32338588...6DB25109`](checksums/SHA256SUMS.txt) |
| Windows Update Restart Guard | 1.0.119 | [WindowsUpdateRestartGuardSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/windows-update-restart-guard/WindowsUpdateRestartGuardSetup.exe) | [Popis a návod](apps/windows-update-restart-guard/README.md) | [`034FF574...61FA5B9A`](checksums/SHA256SUMS.txt) |
