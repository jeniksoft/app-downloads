...
| --- | --- | --- | --- | --- |
| Codex VeraCrypt Startup Mount | 1.0.177 | [VeraCryptStartupMountSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/veracrypt-startup-mount/VeraCryptStartupMountSetup.exe) | [Popis a návod](apps/veracrypt-startup-mount/README.md) | [`A9578CCB...052E3B67`](checksums/SHA256SUMS.txt) |
