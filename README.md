...
| --- | --- | --- | --- | --- |
| Codex VeraCrypt Startup Mount | 1.0.90 | [VeraCryptStartupMountSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/veracrypt-startup-mount/VeraCryptStartupMountSetup.exe) | [Popis a návod](apps/veracrypt-startup-mount/README.md) | [`7BD98857...4E52427F`](checksums/SHA256SUMS.txt) |
| Jarvis | 0.1.118 | [JarvisSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/personal-codex-fallback-host/JarvisSetup.exe) | [Popis a návod](apps/personal-codex-fallback-host/README.md) | [`0890FCC1...C69187B9`](checksums/SHA256SUMS.txt) |
