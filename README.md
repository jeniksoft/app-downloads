...
| --- | --- | --- | --- | --- |
| Codex VeraCrypt Startup Mount | 1.0.56 | [VeraCryptStartupMountSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/veracrypt-startup-mount/VeraCryptStartupMountSetup.exe) | [Popis a návod](apps/veracrypt-startup-mount/README.md) | [`2F672DD9...151F5F31`](checksums/SHA256SUMS.txt) |
| Jarvis | 0.1.77 | [JarvisSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/personal-codex-fallback-host/JarvisSetup.exe) | [Popis a návod](apps/personal-codex-fallback-host/README.md) | [`F0A7C508...A43727FD`](checksums/SHA256SUMS.txt) |
