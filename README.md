...
| --- | --- | --- | --- | --- |
| Jarvis | 0.1.50 | [JarvisSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/personal-codex-fallback-host/JarvisSetup.exe) | [Popis a návod](apps/personal-codex-fallback-host/README.md) | [`AAF9D74D...5EEE9CDE`](checksums/SHA256SUMS.txt) |
