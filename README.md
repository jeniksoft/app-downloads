...
| --- | --- | --- | --- | --- |
| Codex VeraCrypt Startup Mount | 1.0.121 | [VeraCryptStartupMountSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/veracrypt-startup-mount/VeraCryptStartupMountSetup.exe) | [Popis a návod](apps/veracrypt-startup-mount/README.md) | [`6AC7C460...B09B39A5`](checksums/SHA256SUMS.txt) |
| Jarvis | 0.1.151 | [JarvisSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/personal-codex-fallback-host/JarvisSetup.exe) | [Popis a návod](apps/personal-codex-fallback-host/README.md) | [`1D38FE77...87D94985`](checksums/SHA256SUMS.txt) |
