...
| WDUi Framework SDK | 0.1.4 | [WduiFrameworkSdk-0.1.4.zip](https://github.com/jeniksoft/app-downloads/raw/main/apps/wdui-framework/WduiFrameworkSdk-0.1.4.zip) | [Popis a návod](apps/wdui-framework/README.md) | [`BE7A046B...496A0741`](checksums/SHA256SUMS.txt) |
| Windows Update Restart Guard | 1.0.114 | [WindowsUpdateRestartGuardSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/windows-update-restart-guard/WindowsUpdateRestartGuardSetup.exe) | [Popis a návod](apps/windows-update-restart-guard/README.md) | [`290D3968...4DFC694F`](checksums/SHA256SUMS.txt) |
