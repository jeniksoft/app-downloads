...
| --- | --- | --- | --- | --- |
| Codex VeraCrypt Startup Mount | 1.0.124 | [VeraCryptStartupMountSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/veracrypt-startup-mount/VeraCryptStartupMountSetup.exe) | [Popis a návod](apps/veracrypt-startup-mount/README.md) | [`0BD0152E...B03F247F`](checksums/SHA256SUMS.txt) |
