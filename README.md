...
| WDUi Framework SDK | 0.1.11 | [WduiFrameworkSdk-0.1.11.zip](https://github.com/jeniksoft/app-downloads/raw/main/apps/wdui-framework/WduiFrameworkSdk-0.1.11.zip) | [Popis a návod](apps/wdui-framework/README.md) | [`1A84F820...D146AF30`](checksums/SHA256SUMS.txt) |
| Windows Update Restart Guard | 1.0.125 | [WindowsUpdateRestartGuardSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/windows-update-restart-guard/WindowsUpdateRestartGuardSetup.exe) | [Popis a návod](apps/windows-update-restart-guard/README.md) | [`02DD307B...A2024730`](checksums/SHA256SUMS.txt) |
