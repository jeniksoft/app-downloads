...
| --- | --- | --- | --- | --- |
| Windows Update Restart Guard | 1.0.35 | [WindowsUpdateRestartGuardSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/windows-update-restart-guard/WindowsUpdateRestartGuardSetup.exe) | [Popis a návod](apps/windows-update-restart-guard/README.md) | [`423E51E3...9C17871D`](checksums/SHA256SUMS.txt) |
