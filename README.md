...
| WDUi Framework SDK | 0.1.6 | [WduiFrameworkSdk-0.1.6.zip](https://github.com/jeniksoft/app-downloads/raw/main/apps/wdui-framework/WduiFrameworkSdk-0.1.6.zip) | [Popis a návod](apps/wdui-framework/README.md) | [`AF9DD61F...69C6EF9A`](checksums/SHA256SUMS.txt) |
| Windows Update Restart Guard | 1.0.117 | [WindowsUpdateRestartGuardSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/windows-update-restart-guard/WindowsUpdateRestartGuardSetup.exe) | [Popis a návod](apps/windows-update-restart-guard/README.md) | [`C64CDC49...C5DEA71A`](checksums/SHA256SUMS.txt) |
