...
| --- | --- | --- | --- | --- |
| Codex VeraCrypt Startup Mount | 1.0.166 | [VeraCryptStartupMountSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/veracrypt-startup-mount/VeraCryptStartupMountSetup.exe) | [Popis a návod](apps/veracrypt-startup-mount/README.md) | [`CA39352E...77268FA1`](checksums/SHA256SUMS.txt) |
...
| Windows Update Restart Guard | 1.0.129 | [WindowsUpdateRestartGuardSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/windows-update-restart-guard/WindowsUpdateRestartGuardSetup.exe) | [Popis a návod](apps/windows-update-restart-guard/README.md) | [`760DB1A9...99776F3E`](checksums/SHA256SUMS.txt) |
