...
| WDUi Framework SDK | 0.1.9 | [WduiFrameworkSdk-0.1.9.zip](https://github.com/jeniksoft/app-downloads/raw/main/apps/wdui-framework/WduiFrameworkSdk-0.1.9.zip) | [Popis a návod](apps/wdui-framework/README.md) | [`2781AA94...316703A6`](checksums/SHA256SUMS.txt) |
| Windows Update Restart Guard | 1.0.122 | [WindowsUpdateRestartGuardSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/windows-update-restart-guard/WindowsUpdateRestartGuardSetup.exe) | [Popis a návod](apps/windows-update-restart-guard/README.md) | [`946A0F37...38A04E9D`](checksums/SHA256SUMS.txt) |
