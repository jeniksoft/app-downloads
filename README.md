...
| --- | --- | --- | --- | --- |
| Codex VeraCrypt Startup Mount | 1.0.92 | [VeraCryptStartupMountSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/veracrypt-startup-mount/VeraCryptStartupMountSetup.exe) | [Popis a návod](apps/veracrypt-startup-mount/README.md) | [`0C6815C2...C5684FF5`](checksums/SHA256SUMS.txt) |
