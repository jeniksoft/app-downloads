...
| --- | --- | --- | --- | --- |
| Codex VeraCrypt Startup Mount | 1.0.167 | [VeraCryptStartupMountSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/veracrypt-startup-mount/VeraCryptStartupMountSetup.exe) | [Popis a návod](apps/veracrypt-startup-mount/README.md) | [`5326665A...1B5CC27B`](checksums/SHA256SUMS.txt) |
