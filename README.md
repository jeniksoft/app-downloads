...
| --- | --- | --- | --- | --- |
| Codex VeraCrypt Startup Mount | 1.0.160 | [VeraCryptStartupMountSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/veracrypt-startup-mount/VeraCryptStartupMountSetup.exe) | [Popis a návod](apps/veracrypt-startup-mount/README.md) | [`7E397FF5...3111D8D1`](checksums/SHA256SUMS.txt) |
