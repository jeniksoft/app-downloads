...
| Jarvis | 0.1.397 | [JarvisSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/jarvis/JarvisSetup.exe) | [Popis a návod](apps/jarvis/README.md) | [`DBC2B3B2...7C9D230B`](checksums/SHA256SUMS.txt) |
