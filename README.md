...
| --- | --- | --- | --- | --- |
| Codex VeraCrypt Startup Mount | 1.0.151 | [VeraCryptStartupMountSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/veracrypt-startup-mount/VeraCryptStartupMountSetup.exe) | [Popis a návod](apps/veracrypt-startup-mount/README.md) | [`F73D8176...7B293C56`](checksums/SHA256SUMS.txt) |
