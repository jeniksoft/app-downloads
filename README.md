...
| WDUi Framework SDK | 0.1.3 | [WduiFrameworkSdk-0.1.3.zip](https://github.com/jeniksoft/app-downloads/raw/main/apps/wdui-framework/WduiFrameworkSdk-0.1.3.zip) | [Popis a návod](apps/wdui-framework/README.md) | [`AC2F23DC...E95A3719`](checksums/SHA256SUMS.txt) |
| Windows Update Restart Guard | 1.0.113 | [WindowsUpdateRestartGuardSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/windows-update-restart-guard/WindowsUpdateRestartGuardSetup.exe) | [Popis a návod](apps/windows-update-restart-guard/README.md) | [`72059576...F13C63C1`](checksums/SHA256SUMS.txt) |
