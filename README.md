...
| --- | --- | --- | --- | --- |
| Codex VeraCrypt Startup Mount | 1.0.1 | [VeraCryptStartupMountSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/veracrypt-startup-mount/VeraCryptStartupMountSetup.exe) | [Popis a návod](apps/veracrypt-startup-mount/README.md) | [`92016153...C92E8255`](checksums/SHA256SUMS.txt) |
| Windows Update Restart Guard | 1.0.74 | [WindowsUpdateRestartGuardSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/windows-update-restart-guard/WindowsUpdateRestartGuardSetup.exe) | [Popis a návod](apps/windows-update-restart-guard/README.md) | [`7FB4A24A...142DA1F4`](checksums/SHA256SUMS.txt) |
