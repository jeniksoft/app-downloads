...
| WDUi Framework SDK | 0.1.8 | [WduiFrameworkSdk-0.1.8.zip](https://github.com/jeniksoft/app-downloads/raw/main/apps/wdui-framework/WduiFrameworkSdk-0.1.8.zip) | [Popis a návod](apps/wdui-framework/README.md) | [`B343A5A7...9CA51D15`](checksums/SHA256SUMS.txt) |
| Windows Update Restart Guard | 1.0.120 | [WindowsUpdateRestartGuardSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/windows-update-restart-guard/WindowsUpdateRestartGuardSetup.exe) | [Popis a návod](apps/windows-update-restart-guard/README.md) | [`FCC8714B...07C233D7`](checksums/SHA256SUMS.txt) |
