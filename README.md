...
| --- | --- | --- | --- | --- |
| Codex VeraCrypt Startup Mount | 1.0.67 | [VeraCryptStartupMountSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/veracrypt-startup-mount/VeraCryptStartupMountSetup.exe) | [Popis a návod](apps/veracrypt-startup-mount/README.md) | [`33B94614...F6EEF7E5`](checksums/SHA256SUMS.txt) |
