...
| --- | --- | --- | --- | --- |
| Windows Update Restart Guard | 1.0.41 | [WindowsUpdateRestartGuardSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/windows-update-restart-guard/WindowsUpdateRestartGuardSetup.exe) | [Popis a návod](apps/windows-update-restart-guard/README.md) | [`439B9BB5...4702DA2`](checksums/SHA256SUMS.txt) |
