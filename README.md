...
| --- | --- | --- | --- | --- |
| Windows Update Restart Guard | 1.0.44 | [WindowsUpdateRestartGuardSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/windows-update-restart-guard/WindowsUpdateRestartGuardSetup.exe) | [Popis a návod](apps/windows-update-restart-guard/README.md) | [`1B810ADB...A60A4A6D`](checksums/SHA256SUMS.txt) |
