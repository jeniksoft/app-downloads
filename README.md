...
| --- | --- | --- | --- | --- |
| Codex VeraCrypt Startup Mount | 1.0.155 | [VeraCryptStartupMountSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/veracrypt-startup-mount/VeraCryptStartupMountSetup.exe) | [Popis a návod](apps/veracrypt-startup-mount/README.md) | [`47CC3637...C99A8986`](checksums/SHA256SUMS.txt) |
