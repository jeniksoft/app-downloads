...
| WDUi Framework SDK | 0.1.5 | [WduiFrameworkSdk-0.1.5.zip](https://github.com/jeniksoft/app-downloads/raw/main/apps/wdui-framework/WduiFrameworkSdk-0.1.5.zip) | [Popis a návod](apps/wdui-framework/README.md) | [`6D203F04...0FE8DB78`](checksums/SHA256SUMS.txt) |
| Windows Update Restart Guard | 1.0.115 | [WindowsUpdateRestartGuardSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/windows-update-restart-guard/WindowsUpdateRestartGuardSetup.exe) | [Popis a návod](apps/windows-update-restart-guard/README.md) | [`D3BCC333...276490B7`](checksums/SHA256SUMS.txt) |
