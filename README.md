...
| --- | --- | --- | --- | --- |
| Codex VeraCrypt Startup Mount | 1.0.161 | [VeraCryptStartupMountSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/veracrypt-startup-mount/VeraCryptStartupMountSetup.exe) | [Popis a návod](apps/veracrypt-startup-mount/README.md) | [`4E14DE0E...3BEDE386`](checksums/SHA256SUMS.txt) |
