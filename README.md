...
| --- | --- | --- | --- | --- |
| Codex VeraCrypt Startup Mount | 1.0.75 | [VeraCryptStartupMountSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/veracrypt-startup-mount/VeraCryptStartupMountSetup.exe) | [Popis a návod](apps/veracrypt-startup-mount/README.md) | [`14A110FF...A77AAE8F`](checksums/SHA256SUMS.txt) |
| Jarvis | 0.1.113 | [JarvisSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/personal-codex-fallback-host/JarvisSetup.exe) | [Popis a návod](apps/personal-codex-fallback-host/README.md) | [`92C88873...D889F9B7`](checksums/SHA256SUMS.txt) |
