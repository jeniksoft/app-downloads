...
| --- | --- | --- | --- | --- |
| Windows Update Restart Guard | 1.0.50 | [WindowsUpdateRestartGuardSetup.exe](https://github.com/jeniksoft/app-downloads/raw/main/apps/windows-update-restart-guard/WindowsUpdateRestartGuardSetup.exe) | [Popis a návod](apps/windows-update-restart-guard/README.md) | [`8EF7F215...16A96BF3`](checksums/SHA256SUMS.txt) |
